...
function AppInner() {
  ...
  const NAV = [
    ...
    { id: 'vendors_dump', label: 'Market Vendors', Icon: Building2, color: '#f59e0b', section: 'jksuper', permKey: 'vehicle', badge: 'NEW' },
    ...
    { id: 'vendors_jharli', label: 'Market Vendors', Icon: Building2, color: '#f59e0b', section: 'jharli', permKey: 'vehicle', badge: 'NEW' },
