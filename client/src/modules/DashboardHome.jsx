...
export default function DashboardHome({ filteredNavIds = new Set(), navItems = [] }) {
    ...
    const { cfg, lrs, vouchers, cashbook, maintAlerts, vehicles, attendanceToday, kpis, recentActivity, ownVehiclesDuty, refetch } = useDashboardData();
    ...
    return (
        <div className="page-container">
            ...
            {/* Today's roll-call, marked here. Admin only */}
            {isAdmin && (
                <TodayRollCall
            ...
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(320px, 1fr))', gap: '16px' }}>
                ...
                {/* Own Vehicles Duty Status Card (Replaces Fleet Alerts) */}
